						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td width="59%"><input type="text" name="username"
									id="textfield" class="my_txt_350" value="${buser.username}" /></td>
								<td width="25%">${msg }</td>
							</tr>
							<tr>
								<td align="right">&nbsp;</td>
							...
							<tr>
								...
								<td><input type="repassword" name="repassword" id="textfield3"
									class="my_txt_350" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								<td align="right">&nbsp;</td>
								<td height="50"><input type="submit" name="button" id="button" onclick="checkForm()" value="注册账号" class="my_ann1" /></td>
								<td>&nbsp;</td>
							</tr>
						</table>
					</form:form>
