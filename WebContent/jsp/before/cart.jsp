...
<script type="text/javascript">
	...
	function  goOrderConfirm(){
		window.location.href="${pageContext.request.contextPath }/cart/orderConfirm";
	}
	//清空
	function godelete(){
	...
	function deleteAgoods(gno){
		if(window.confirm("真的删除该商品吗？")){
			window.location.href="${pageContext.request.contextPath }/cart/deleteAgoods?id=" + gno;
			return true;
		}
		return false;
	}
