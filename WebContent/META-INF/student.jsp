		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="post" 
					...
					<a href="${basePath}addStudent.action"> <button type="button" class="btn btn-default">添加</button></a> 
				</form>
						...
						<tbody>
							...
							<c:forEach var="student" items="${page.rows}" varStatus="status" >
								<tr >
									...
									<td>
										<c:out value="${student.jobs }"/>
									</td>
									<td>
										<c:out value="${student.phone }"/>
									</td>
									<td>
										<a href="${pageContext.request.contextPath }/toEditStudent.action?id=${student.id }">编辑 </a>
